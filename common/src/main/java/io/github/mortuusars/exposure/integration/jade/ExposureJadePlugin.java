// Jade integration disabled: missing Jade dependency
...
//    public static final Identifier LIGHTROOM = Exposure.resource("lightroom");
//    public static final Identifier PHOTOGRAPH_FRAME = Exposure.resource("photograph_frame");
//
//    @Override
